...
namespace Microsoft.Framework.DependencyInjection
{
    ...
    public static class EntityServiceCollectionExtensions
    {
        ...
        ///         <c>collection.UseEntityFramework(config).UseSqlServer()</c>.
        ///     </para>
        ///     <para>
        ...
        /// <summary>
        ///     Registers the given context as a service in the <see cref="IServiceCollection" />. This will ensure services that
        ///     the context uses are resolved from the <see cref="IServiceProvider" /> and any Entity Framework configuration 
