...
namespace System.Linq
{
    public static class QueryableExtensions
    {
        ...
        ///     </para>
        ///     <para>
        ///         Once you have used this method to include a related entity you can chain a call to <see cref="ThenInclude" />
        ///         to include further data that is related to the entity that was just included
        ///         <c>query.Include(blog => blog.Posts).ThenInclude(post => post.Tags)</c>.
        ///     </para>
        ///     <para>
        ///     </para>
        /// </summary>
        ...
        /// <param name="source"> The source query to include related data in. </param>
        /// <param name="navigationPropertyPath">
        ///     A lambda expression representing the related data to include (<c>blog => blog.Posts</c>).
        /// </param>
        /// <returns>
        ///     A new query object with the related data included. The returned object also allows <see cref="ThenInclude" />
        ///     calls to be chained to specify additional levels of data to be included based on navigation properties of the
        ///     related entity that was just included.
        /// </returns>
        ...
        /// <summary>
        ///     <para>
        ///         Specifies additional related entities to be included in the query results based on an entity
        ///         that was included in the previous API call.
        ///     </para>
        /// </summary>
        /// <typeparam name="TEntity"> The type of entity being queried. </typeparam>
        /// <typeparam name="TPreviousProperty"> 
        ///     The type of entity included in the previous call to <see cref="Include"/> or 
        ///     <see cref="ThenInclude"/>. 
        /// </typeparam>
        /// <typeparam name="TProperty"> The type of the navigation property to be included. </typeparam>
        /// <param name="source"> The source query to include related data in. </param>
        /// <param name="navigationPropertyPath">
